...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		...
		snakeBody.add(new Location(1, 3));
		snakeBody.add(new Location(1, 2));
		snakeBody.add(new Location(1, 1));
		snakeBody.add(new Location(0, 1));
		snakeBody.add(new Location(0, 2));
		snakeBody.add(new Location(0, 3));
		snakeBody.add(new Location(0, 4));
		snakeBody.add(new Location(1, 4));
		snakeBody.add(new Location(1, 5));
		snakeBody.add(new Location(1, 6));
		snakeBody.add(new Location(1, 7));
		snakeBody.add(new Location(1, 8));
