...
public class Move {
	...
	public static int connectingDots(int boardHeight, int boardWidth, List<SnakeInfo> otherSnakes, SnakeInfo mySnake,
		...
		if (!left.equals(from) && !left.equals(start)) {
			if (left.isEmpty(boardHeight, boardWidth, otherSnakes, mySnake, topBottomRule)) {
		...
		if (!right.equals(from) && !right.equals(start)) {
			if (right.isEmpty(boardHeight, boardWidth, otherSnakes, mySnake, topBottomRule)) {
		...
		if (!up.equals(from) && !up.equals(start)) {
			if (up.isEmpty(boardHeight, boardWidth, otherSnakes, mySnake, topBottomRule)) {
		...
		if (!down.equals(from) && !down.equals(start)) {
			if (down.isEmpty(boardHeight, boardWidth, otherSnakes, mySnake, topBottomRule)) {
